...
export default props => {
    ...
    useEffect(() => {
        axios(`${baseUrl}/projetos/password/index`).then(resp => {
            setState((prevState) => {
    ...
    return (
        <Main>
            <div className={`${styles['box']}`}>
                <div className={`${styles['menu-indice']}`}>
                    <span className={`${styles['indice-span-data']}`}>
                            Data
                    </span>
                    <span className={`${styles['indice-span-user']}`}>
                            Usuário
                    </span>
                    <span className={`${styles['indice-span-email']}`}>
                            Email
                    </span>
                    <span className={`${styles['indice-span-site']}`}>
                            Site usado
                    </span>
                ...
                <Link className={`${styles['link-aside']}`}  to="/cadastro/senhas">
